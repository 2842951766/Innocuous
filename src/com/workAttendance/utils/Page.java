...
/**
 * Created by cxcl on 2017/8/16.
 * update by mq.liu 2018/08/14 修改getEndIndex
 */
...
//        this.endIndex = end;
        this.endIndex = end - this.getStartIndex();//hibernate分页仍然采用的是mysql的limit分页，从第几条开始，取出几条，而不是传入开始位置结束位置,update by mq.liu
